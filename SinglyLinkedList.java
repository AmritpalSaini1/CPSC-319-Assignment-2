 ...
 */
/**
 * A basic singly linked list implementation. A linked list, in its simplest
 * form, is a collection of nodes that collectively form a linear sequence. In a
 * singly linked list, each node stores a reference to an object that is an
 * element of the sequence, as well as a reference to the next node of the list.
 * <p>
 * Adapted from: 3.2.1 Implementing a Singly Linked List Class :Data Structures
 * and Algorithms in Java, Sixth Edition
 * <p>
 * 
...
public class SinglyLinkedList<E> {
     ...
     * @return if index is out of range return null otherwise, return the
     *         element at the specified position in the list if index is out
     */
